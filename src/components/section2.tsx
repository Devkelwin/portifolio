  ...
  return (
    <section style={{ alignItems: 'center', justifyContent: 'center', textAlign: 'center'}}>
      <div style={{ justifyContent: 'center', padding: 20,alignItems: 'center' }}>
        <div style={{ background: "#182337", borderRadius: 40, marginTop: '3%', padding: 25,width: 450,height: '100%'}}>
        ...
        <div style={{ background: "#182337", borderRadius: 40, marginTop: '3%', padding: 25, width:450,alignItems: 'center',height: '100%' }}>
